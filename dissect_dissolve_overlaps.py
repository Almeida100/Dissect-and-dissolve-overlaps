...
from .dissect_dissolve_overlaps_provider import DissectAndDissolveOverlapsProvider
...
class DissectAndDissolveOverlapsPlugin(object):
    ...
    def initProcessing(self):
        ...
        self.provider = DissectAndDissolveOverlapsProvider()
