...
class DissectAndDissolveOverlapsAlgorithm(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(QgsProcessingParameterFeatureSink('Self_intersected', 'Self_intersected', type=QgsProcessing.TypeVectorAnyGeometry, createByDefault=True, supportsAppend=True, defaultValue='Intersected.shp'))
        self.addParameter(QgsProcessingParameterFeatureSink('Dissectedanddissolved', 'DissectedAndDissolved', type=QgsProcessing.TypeVectorAnyGeometry, createByDefault=True, supportsAppend=True, defaultValue='Dissolved.shp'))
...
# *************************************************   Section2: Dissect overlaps   **************************************************************
        ...
        if find2 or find3:
            ...
            alg_params = {
                ...
                'OUTPUT': parameters['Self_intersected']
            }
            outputs['DropFields'] = processing.run('native:deletecolumn', alg_params, context=context, feedback=feedback, is_child_algorithm=True)
            results['Self_intersected'] = outputs['DropFields']['OUTPUT']
...
# *************************************************   Section3: Dissolve overlaps   **************************************************************
    ...
    def displayName(self):
        return 'Dissect and dissolve overlaps Ver. 0.4'
